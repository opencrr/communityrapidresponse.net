...
func setupConnectionTestSuite(t *testing.T) *ConnectionTestSuite {
	...
	groupHandler := NewGroupHandler(groupRepo, signalGroupRepo, meshtasticChannelRepo, regionRepo, userRepo, auditRepo)
...
func TestConnectionHandler_ProposeSignalChat_AdminOnly_OptionalEncryption(t *testing.T) {
	s := setupConnectionTestSuite(t)
